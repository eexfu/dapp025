...
public class MenuEndpoint {
    ...
    public GetCheapestMealResponse getCheapestMeal(@RequestPayload GetCheapestMealRequest request) {
        GetCheapestMealResponse reponse = new GetCheapestMealResponse();
        reponse.setMeal(mealrepo.findCheapestMeal());
    ...
    public AddOrderResponse addOrder(@RequestPayload AddOrderRequest request) {
        ...
        reponse.setOrder(mealrepo.addOrder(request.getAddress(), request.getMeals().getMealName()));
